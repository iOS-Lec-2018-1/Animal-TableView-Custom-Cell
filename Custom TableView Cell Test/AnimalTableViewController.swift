...
class AnimalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "RE", for: indexPath) as! AnimalTableViewCell

        // Configure the cell...
        cell.animalName.text = animalNames[indexPath.row]
        cell.animalImage.image = UIImage(named: animalImages[indexPath.row])
        cell.animalCountry.text = country[indexPath.row]
        cell.animalYear.text = year[indexPath.row]
